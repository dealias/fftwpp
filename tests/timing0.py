...
def main(argv):
    ...
    if dorun:
        ...
        if(stats == -1):
            try:
                os.remove("implicit.dat")
                os.remove("implicit0.dat")
                os.remove("explicit.dat")
            except OSError:
                pass
        ...
        if(stats == -1):
            ...
            os.rename("implicit.dat", outdir + "/" + outfile + "implicit.dat")
            os.rename("implicit0.dat", outdir + "/" + outfile + "implicit0.dat")
            os.rename("explicit.dat", outdir + "/" + outfile + "explicit.dat")
